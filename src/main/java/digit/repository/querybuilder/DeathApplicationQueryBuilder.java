...
// Query Builder for Death Application
@Component
public class DeathApplicationQueryBuilder {
    ...
    private static final String FROM_TABLES = " FROM dt_registration dtr INNER JOIN dt_address add ON dtr.id = add.registrationid ";
    ...
    // Function add the Clause according to the requirement
